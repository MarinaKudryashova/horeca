...
/* harmony import */ var _components_full_descr__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/full-descr */ "./src/js/components/full-descr.js");
...
/***/ "./src/js/components/full-descr.js":
/*!*****************************************!*\
  !*** ./src/js/components/full-descr.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const product = new graph_tabs__WEBPACK_IMPORTED_MODULE_0__["default"]('product');
...
const sliderThumbs = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.slider__thumbs .swiper-container', {
...
const sliderImages = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.slider__images .swiper-container', {
  // ищем слайдер превью по селектору
  // задаем параметры
  direction: 'vertical',
  // вертикальная прокрутка
...
// product-slider
const prodactImage = document.querySelector(".product-slider__images");
const prodactImageThumbs = document.querySelector(".product-slider__thumb");
const prodactSliderNav = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](prodactImageThumbs, {
  direction: 'vertical',
  spaceBetween: 10,
  slidesPerView: 4,
  freeMode: true,
...
const prodactSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](prodactImage, {
  direction: 'vertical',
  // вертикальная прокрутка
  // spaceBetween: 30,
  slidesPerView: 1,
